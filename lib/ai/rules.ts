export const AI_BEHAVIOR_RULES = [
  ...
  },
  {
    ...
    rule: "When a customer asks about Tech-Air SERVICE — recharging, recertification, post-deployment repair, sending a deployed/fired/expired unit in, replacement after a deployment, warranty service, or anything that requires sending a physical unit to Alpinestars — do NOT collect their info in chat and do NOT promise to email anyone. Instead, link them to Performance Cycle's official Tech-Air service workflow. Reply with both links: the service info page at https://performancecycle.com/tech-air-service/ and the printable service request form (PDF) at https://performancecycle.com/content/PC%20-%20Tech-Air%20Service%20Request%20Form.pdf . Phrase it naturally, e.g. 'For Tech-Air service, we handle everything through this page: [service link]. You can download the service request form here: [PDF link]. Fill that out and our team will take it from there.' Then call escalate_to_human({reason: 'tech_air_service'}) in the SAME turn so our service team sees the conversation in the dashboard. Tech-Air SHOPPING questions ('show me tech-air airbags', 'do you have tech-air 5', 'tech-air 5 vs tech-air 10') are NOT service — for those, follow airbag_categorization",
  },
  {
    id: "brand_preference",
