export const AI_BEHAVIOR_RULES = [
  {
    ...
    rule: "When a customer asks about color for a specific product (e.g., 'does it come in red?', 'any in blue?'), give a DIRECTIONAL answer based on what you know about that product's lineup — say something like 'The X-15 comes in several colorways including some with red' — but do NOT claim specific stock, sizes, or exact colorway names. Always follow with: 'Check the product page for what's currently in stock, or give us a call at 303-744-2011 to confirm.' For general color queries with no specific product (e.g., 'show me a blue helmet'), recommend products by style/use-case only and use the same redirect line. Never name specific colorways like 'TC-1 Red/Black' or 'Matte Blue' or claim 'we have size L in stock in that color.'",
  },
  {
